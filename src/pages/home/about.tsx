...
function About() {
    return (
        <section className="min-h-svh w-full bg-linear-to-t from-bg to-secondary/30 flex items-center justify-center flex-col p-10 gap-8">
            <div className="flex items-center justify-center flex-col">
                <h2 className="text-4xl font-title text-center">Who am I?</h2>
                <p className="mt-6 text-xl leading-relaxed text-center">
